          ...
          htmltools::tags$tr(
            ...
            htmltools::tags$th(
              ...
              htmltools::tagList(
                ...
                htmltools::tags$span(
                  class = "info-icon",
                  `data-tooltip` = "The difference between branch main and branch dev: \n A positive number means dev is ahead of main;\n A negative number means dev is behind main;\n \"Unvailable\" means either branch is missing.",
                  `aria-label` = "The difference between branch main and branch dev: A positive number means dev is ahead of main; A negative number means dev is behind main; \"Unvailable\" means either branch is missing.",
                  tabindex = "0",
                  "i"
                )
              )
